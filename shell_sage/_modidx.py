...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'shell_sage.config': { 'shell_sage.config.ShellSageConfig': ('config.html#shellsageconfig', 'shell_sage/config.py'),
            ...
            'shell_sage.core': { 'shell_sage.core._aliases': ('core.html#_aliases', 'shell_sage/core.py'),
                                 ...
                                 'shell_sage.core.fmt_doc': ('core.html#fmt_doc', 'shell_sage/core.py'),
                                 'shell_sage.core.get_docs': ('core.html#get_docs', 'shell_sage/core.py'),
            ...
            'shell_sage.rag': { 'shell_sage.rag.EmbeddingTable': ('rag.html#embeddingtable', 'shell_sage/rag.py'),
                                'shell_sage.rag.LanceTable.search': ('rag.html#lancetable.search', 'shell_sage/rag.py'),
                                'shell_sage.rag._get_page': ('rag.html#_get_page', 'shell_sage/rag.py'),
                                'shell_sage.rag._manpages': ('rag.html#_manpages', 'shell_sage/rag.py'),
                                'shell_sage.rag._section': ('rag.html#_section', 'shell_sage/rag.py'),
                                'shell_sage.rag.index': ('rag.html#index', 'shell_sage/rag.py'),
                                'shell_sage.rag.index_manpages': ('rag.html#index_manpages', 'shell_sage/rag.py')}}}
